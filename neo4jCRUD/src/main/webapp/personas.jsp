    ...
    <form action="PersonasController">
        ...
        <div class="mb-3">
            ...
            <table class="table">
                ...
                <tr>
                    <th scope="col" style="width: 1%; white-space: nowrap;">Código</th>                                <th scope="col">Nombres</th>
                ...
                <c:forEach var="persona" items="${lista_personas}">
                    <tr style="width: 1%;">
                        ...
                        <td>
                            <a href="PersonasController?accion=editar&codigo=${persona.id}" class="btn btn-outline-success">
                                <span class="bi bi-arrow-left"></span>Editar
                            </a>
                            <a href="PersonasController?accion=eliminar&codigo=${persona.id}" class="btn btn-outline-warning">
